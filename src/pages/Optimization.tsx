...
import { Target, Clock, TrendingUp, Hash, Lightbulb, Calendar, BarChart, ExternalLink } from 'lucide-react';
...
const Optimization: React.FC = () => {
  ...
  const openContentIdeas = () => {
    window.open('https://www.facebook.com/business/help/218673161711525', '_blank');
  };

  const openHashtagTool = () => {
    window.open('https://www.facebook.com/business/help/1240182842783684', '_blank');
  };
